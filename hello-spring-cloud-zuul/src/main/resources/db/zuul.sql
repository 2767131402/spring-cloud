...
-- ----------------------------
INSERT INTO `gateway_zuul_route` VALUES ('1', '/api/c/**', 'hello-spring-cloud-service', NULL, 0, 1, 1, NULL);
INSERT INTO `gateway_zuul_route` VALUES ('2', '/api/b/**', 'hello-spring-cloud-web-admin-feign', NULL, 0, 1, 1, NULL);
INSERT INTO `gateway_zuul_route` VALUES ('3', '/api/a/**', 'hello-spring-cloud-web-admin-ribbon', NULL, 0, 1, 1, NULL);
